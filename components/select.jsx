...
const SelectInput = ({ onClick, title, selected }) => {
    ...
    return (
        <div className="flex gap-2 " onClick={onClick} >
            <input checked={selected} type="checkbox" id={id} className="relative peer cursor-pointer shrink-0 appearance-none w-4 h-4 border-2 border-blue-500 rounded-sm bg-white mt-1 checked:bg-blue-800 checked:border-0" />
...
//       {selected && (
//         <svg
//           className="absolute  w-4 h-4 mt-1 block"
//           xmlns="http://www.w3.org/2000/svg"
//           viewBox="0 0 24 24"
//           fill="none"
//           stroke="white"
